...
class FluxSGPipeline(FluxPipeline):
    @property
    ...
    def __call__(
        ...
        pag_scale: float = 3.0,
        self_guidance_scale: float = 3.0,
        self_guidance_shift_t: Union[int, List[int]] = 10,
        ...
        if self.guidance_embed:
            ...
            guidance = None
            self.transformer.time_text_embed=CombinedTimestepTextProjEmbeddings(embedding_dim=self.transformer.inner_dim, pooled_projection_dim=self.transformer.config.pooled_projection_dim
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if self.do_self_guidance:
                    noise_pred = noise_pred + self.self_guidance_scale * (
